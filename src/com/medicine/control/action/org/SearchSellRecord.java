...
public class SearchSellRecord implements FunctionAction, ActionListener {
	...
	private void init() {
		...
		this.typeComboBox = new JComboBox<String>(new String[] { "按年查找",
				"按年月查找", "按年月日查找" });
		this.dateLabel = new JLabel("销售日期：");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (souce == this.searchButton) {
			...
			String sql = "SELECT sellRecord.sellId as '销售ID',"
					...
					+ "convert(char(10),sellDate, 120) LIKE ?";
			String[] parse = null;
